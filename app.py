...
<style>
    ...
    .val-main { font-size: 1.8rem; font-weight: bold; font-family: monospace; text-align: right; color: #fff; line-height: 1.2; }
    ...
    .sim-val { font-size: 1.3rem; font-weight: bold; color: #fff; text-align: right; font-family: monospace;}
    ...
    .hist-table td { border: 1px solid #444; padding: 5px; text-align: center; color: #ddd; font-family: monospace;}
